...
protected:
   ...
   // statistics
   omnetpp::cHistogram qDepthHist;         // number of flits in the out queue
   omnetpp::cHistogram packetStoreHist;  // number of packets in the queue
   omnetpp::cHistogram flowControlDelay; // track the time between flow controls
