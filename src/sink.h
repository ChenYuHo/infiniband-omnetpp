...
private:
    ...
    // statistics
    omnetpp::cHistogram PakcetFabricTime;
    ...
    omnetpp::cHistogram msgLatency;        // the network latency of received messages from the
                                                 // time first msg flit was injected to the time last msg flit received
    omnetpp::cHistogram msgF2FLatency;     // the network latency of received messages from the
                                                 // time first msg flit was injected to the time last packet first flit received
    omnetpp::cHistogram enoughPktsLatency; // the network latency of received repFirstPackets of the messages
